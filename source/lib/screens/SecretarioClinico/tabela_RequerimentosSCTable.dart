...
class _RequerimentosTableSCState extends State<RequerimentosSCTable> {
                        ...
                        cells: [
                          ...
                          DataCell(
                            IconButton(
                              ...
                              color: Colors.blue,
                              onPressed: () {
                                showUtenteDetailsOverlay(context,
                                    widget.requerimentos, requerimento);
                              },
                            ),
                          ),
                        ],
  ...
  void showUtenteDetailsOverlay(BuildContext context,
      List<RequerimentoSC> requerimentos, RequerimentoSC requerimento) {
    showDialog<void>(
      context: context,
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
            ...
            actions: <Widget>[
              Expanded(
                // Usa o widget Expanded para os botões ocuparem o espaço horizontalmente
                child: Row(
                  mainAxisAlignment: MainAxisAlignment
                      .center, // Distribui o espaço uniformemente
                  children: [
                    TextButton(
                      onPressed: () async {
                      ...
                      style: TextButton.styleFrom(
                        ...
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(
                              20), // Arredonda os cantos do botão
                        ),
                      ),
